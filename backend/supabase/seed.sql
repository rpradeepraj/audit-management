...
(
    ...
    'gtmpl_iso14001',
    'PCS-EMS-2026',
    'Apex Environmental Management & Carbon Footprint Audit Protocol',
    'ISO 14001:2015',
    'Energy & Sustainable Manufacturing',
    '2.1',
    85.00,
    ARRAY['Apex', 'ISO 14001', 'EMS', 'Sustainability', 'Carbon Reduction'],
    'Apex proprietary environmental compliance and carbon lifecycle audit framework.',
    true,
    'usr_apex_marcus'
),
(
    ...
    'gtmpl_iso27001',
    'OTAB-ISMS-2026',
    'OmniTech Zero-Trust & ISO 27001:2022 ISMS Audit Framework',
    'ISO/IEC 27001:2022',
    'Information Technology & Cloud Infrastructure',
    '3.0',
    88.00,
    ARRAY['OmniTech', 'ISO 27001', 'Zero Trust', 'Cybersecurity', 'ISMS'],
    'Comprehensive information security management system audit protocol incorporating ISO/IEC 27001:2022 Annex A controls.',
    true,
    'usr_cyber_alex'
)
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ...
    -- CyberGuard SOC 2 Sections
    ('fsec_ccs_soc2_s1', 'ftmpl_cyber_cloud_soc2', 'gsec_soc2_cc6', 'CC6: Logical and Physical Access Controls', 'Zero-trust IAM enforcement, ephemeral credentials, and MFA.', 50.00, 1),
    ('fsec_ccs_soc2_s2', 'ftmpl_cyber_cloud_soc2', 'gsec_soc2_cc7', 'CC7: System Operations & Continuous Monitoring', 'SIEM log telemetry, vulnerability scanning, and incident response SLAs.', 50.00, 2),
    -- Apex EMS Sections
    ('fsec_pcs_ems_s1', 'ftmpl_pcs_iso14001', 'gsec_iso14001_s6', 'Clause 6: Environmental Aspects, Compliance Obligations & Risk', 'Identification of environmental aspects, life-cycle perspective, and legal compliance register.', 40.00, 1),
    ('fsec_pcs_ems_s2', 'ftmpl_pcs_iso14001', 'gsec_iso14001_s8', 'Clause 8: Operational Planning, Waste Control & Emergency Response', 'Hazardous material handling, effluent discharge control, and spill emergency preparedness.', 60.00, 2),
    -- OmniTech ISMS Sections
    ('fsec_otab_isms_s1', 'ftmpl_otab_iso27001', 'gsec_iso27001_s5', 'Annex A.5: Organizational Information Security & Risk Governance', 'Information security policies, roles, segregation of duties, and supplier relationships.', 40.00, 1),
    ('fsec_otab_isms_s2', 'ftmpl_otab_iso27001', 'gsec_iso27001_s8', 'Annex A.8: Technological Controls, EDR & Threat Intelligence', 'Privileged access management, data leakage prevention (DLP), and endpoint telemetry.', 60.00, 2)
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ...
    -- CyberGuard SOC 2 Questions
    ('fq_ccs_soc2_61', 'fsec_ccs_soc2_s1', 'gq_soc2_cc61', 'CCS-SOC2: CC6.1', 'Are all cloud production credentials rotated automatically within 90 days and protected by hardware security keys?', 'Review IAM policy configs, KMS key rotation logs, and session timeout policies.', 'PASS_FAIL', 20.00, true, 1),
    ('fq_ccs_soc2_71', 'fsec_ccs_soc2_s2', 'gq_soc2_cc71', 'CCS-SOC2: CC7.1', 'Is continuous vulnerability scanning configured with automated alerting for critical CVEs within 24 hours?', 'Audit container registry scan reports, cloud security posture logs, and patch verification tickets.', 'PASS_FAIL', 20.00, true, 1),
    -- Apex EMS Questions
    ('fq_pcs_ems_612', 'fsec_pcs_ems_s1', 'gq_iso14001_612', 'PCS-EMS: 6.1.2', 'Has the facility quantified direct Scope 1 and Scope 2 GHG emissions with verified reduction targets?', 'Review energy consumption records, carbon accounting sheets, and annual sustainability reports.', 'PASS_FAIL', 15.00, true, 1),
    ('fq_pcs_ems_82', 'fsec_pcs_ems_s2', 'gq_iso14001_82', 'PCS-EMS: 8.2', 'Are emergency response drill logs, chemical spill containment barriers, and secondary bunding inspected quarterly?', 'Audit chemical storage yards, eyewash station logs, spill kit manifests, and evacuation drill reports.', 'PASS_FAIL', 20.00, true, 1),
    -- OmniTech ISMS Questions
    ('fq_otab_isms_51', 'fsec_otab_isms_s1', 'gq_iso27001_51', 'OTAB-ISMS: A.5.1', 'Are overarching information security policies reviewed at least annually and approved by executive management?', 'Inspect corporate security charter, policy revision timestamps, and executive committee sign-off.', 'PASS_FAIL', 15.00, true, 1),
    ('fq_otab_isms_82', 'fsec_otab_isms_s2', 'gq_iso27001_82', 'OTAB-ISMS: A.8.2', 'Are privileged user access rights and administrator tokens enforced with mandatory phishing-resistant FIDO2/MFA and 90-day recertification?', 'Examine IAM access reviews, PAM vault audit logs, and hardware security key enforcement policies.', 'PASS_FAIL', 20.00, true, 1)
ON CONFLICT (id) DO NOTHING;
