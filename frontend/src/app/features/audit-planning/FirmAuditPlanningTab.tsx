          ...
          onSave={(auditData) => {
            try {
              if (editingAuditId) {
                ...
                showSuccess(`Audit engagement "${auditData.title || "Audit Plan"}" scheduled successfully.`);
              }
            } catch (err: any) {
              showError(err.message || "Failed to save audit plan.");
            }
        ...
        <RescheduleModal
          ...
          onSave={(auditId, updates) => {
            try {
              ...
              showSuccess(`Audit ${reschedulingAudit.auditNumber} rescheduled successfully.`);
            } catch (err: any) {
              showError(err.message || "Failed to reschedule audit.");
            }
